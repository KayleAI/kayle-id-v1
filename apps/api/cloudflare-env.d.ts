/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: 04d11d4808e9dd38dc0d8f4728274620)
