/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: 6fe80d1d9e7c60894fc69be6f40c7bbd)
// Runtime types generated with workerd@1.20260415.1 2026-03-20 nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		KAYLE_ID_ANALYTICS: AnalyticsEngineDataset;
		NODE_ENV: "production";
	...
	interface StagingEnv {
		...
		EMAIL_FROM_ADDRESS: "Kayle ID <security@care.kayle.id>";
		MIN_APP_VERSION: "1.4.1";
		BIOMETRIC_VERIFIER: Fetcher /* kayle-id-biometric-verifier-staging */;
		WEBHOOK_DELIVERY_WORKFLOW: Workflow<Parameters<import("./src/index").WebhookDeliveryWorkflow['run']>[0]['payload']>;
	}
	interface TestEnv {
		STORAGE: R2Bucket;
	...
	interface Env {
		...
		KAYLE_ENVIRONMENT: "production" | "staging" | "test" | "development";
		PUBLIC_AUTH_URL: "https://kayle.id" | "https://staging.kayle.id" | "http://localhost:3000";
		PUBLIC_VERIFY_URL: "https://verify.kayle.id" | "https://verify.staging.kayle.id" | "http://localhost:2999";
		PUBLIC_CDN_ORIGIN?: "https://cdn.kayle.id" | "https://cdn.staging.kayle.id";
		EMAIL_FROM_ADDRESS: "Kayle ID <security@care.kayle.id>";
		MIN_APP_VERSION?: "1.4.1" | "";
		KAYLE_INTERNAL_TOKEN?: string;
		AUTH_SECRET?: string;
		...
		CLOUDFLARE_API_TOKEN?: string;
		CLOUDFLARE_ACCOUNT_ID?: string;
		BIOMETRIC_VERIFIER: Fetcher /* kayle-id-biometric-verifier */ | Fetcher /* kayle-id-biometric-verifier-staging */;
		WEBHOOK_DELIVERY_WORKFLOW: Workflow<Parameters<import("./src/index").WebhookDeliveryWorkflow['run']>[0]['payload']>;
		VERIFY_PKD_TRUST_BUNDLE_JSON?: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "KAYLE_ENVIRONMENT" | "PUBLIC_AUTH_URL" | "PUBLIC_VERIFY_URL" | "PUBLIC_CDN_ORIGIN" | "EMAIL_FROM_ADDRESS" | "MIN_APP_VERSION" | "KAYLE_INTERNAL_TOKEN" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BIOMETRIC_VERIFIER_SECRET" | "ORG_VERIFICATION_PEPPER" | "REDIS_URL" | "REDIS_TOKEN" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "VERIFY_PKD_TRUST_BUNDLE_JSON">> {}
}
