/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: 5153a5fb6cf35d14091bd7149984bfba)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_AUTH_URL" | "EMAIL_FROM_ADDRESS" | "KAYLE_INTERNAL_TOKEN" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FACE_MATCHER_SECRET" | "ORG_VERIFICATION_PEPPER" | "VERIFY_PKD_TRUST_BUNDLE_JSON">> {}
}
