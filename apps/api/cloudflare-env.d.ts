/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: e828e27864896cf4bd04efb7dd5918ad)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		RESEND_FROM_EMAIL: "Kayle ID <security@care.kayle.id>";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_AUTH_URL" | "RESEND_FROM_EMAIL" | "KAYLE_INTERNAL_TOKEN" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "FACE_MATCHER_SECRET" | "VERIFY_PKD_TRUST_BUNDLE_JSON">> {}
}
