...
nonisolated func shareFieldDetailText(
  ...
  default:
    return fallbackShareFieldDetailText(
      field,
...
nonisolated func parseAgeOverThreshold(_ value: String) -> Int? {
...
nonisolated private func fallbackShareFieldDetailText(
  _ field: VerifyShareRequestField,
  previewContext: VerifySharePreviewContext?,
  referenceDate: Date
) -> String {
  guard let threshold = parseAgeOverThreshold(field.key) else {
    return field.reason
  }
