/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: a90734b685efec9cd1191f584b0ff483)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		ORG_VERIFICATIONS_KV: KVNamespace;
		...
		KAYLE_PLATFORM_WEBHOOK_SECRET: string;
		KAYLE_PLATFORM_WEBHOOK_DECRYPTION_KEY: string;
	...
	interface StagingEnv {
		...
		DEMO_RUNS: DurableObjectNamespace<import("./src/server-entry").DemoRunMailbox>;
		API: Fetcher /* kayle-id-api-staging */;
	}
	interface Env {
		ORG_VERIFICATIONS_KV?: KVNamespace;
		KAYLE_ID_ANALYTICS?: AnalyticsEngineDataset;
		NODE_ENV: "production" | "development";
		KAYLE_ENVIRONMENT: "production" | "staging" | "development";
		KAYLE_INTERNAL_TOKEN?: string;
		KAYLE_INTERNAL_API_KEY?: string;
		KAYLE_PLATFORM_WEBHOOK_SECRET?: string;
		KAYLE_PLATFORM_WEBHOOK_DECRYPTION_KEY?: string;
		KAYLE_DEMO_API_KEY?: string;
		DEMO_RUNS: DurableObjectNamespace<import("./src/server-entry").DemoRunMailbox>;
		API: Fetcher /* kayle-id-api */ | Fetcher /* kayle-id-api-staging */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "KAYLE_ENVIRONMENT" | "KAYLE_INTERNAL_TOKEN" | "KAYLE_INTERNAL_API_KEY" | "KAYLE_PLATFORM_WEBHOOK_SECRET" | "KAYLE_PLATFORM_WEBHOOK_DECRYPTION_KEY" | "KAYLE_DEMO_API_KEY">> {}
}
