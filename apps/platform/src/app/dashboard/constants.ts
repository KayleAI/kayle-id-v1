...
export const METRIC_CONFIG: Record<DisplayMetricKey, MetricConfig> = {
	...
	success: {
		description: "Sessions where Kayle ID confirmed at least one attempt.",
		dotClassName: "bg-[#10b981]",
		label: "Successful",
		stroke: "#10b981",
		title: "Successful verification sessions",
	},
	failure: {
		description: "Sessions that failed verification.",
	...
	cancelled: {
		description: "Sessions that were cancelled before completion.",
