...
export type EndpointDeliveryStats = {
  failed: number;
  inFlight: number;
...
export type CreateEndpointInitialPublicKey = {
  jwk: JsonWebKey;
  keyId: string;
};

export type CreateEndpointSubmission = {
  enabled: boolean;
...
export type CreateEndpointSubmissionResult = {
