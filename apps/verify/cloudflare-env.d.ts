/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: f1105d1f6227c7851055f8e39acb2795)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PUBLIC_API_HOST: "api.kayle.id" | "api.staging.kayle.id";
		PUBLIC_API_PROTOCOL: "wss";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "KAYLE_ENVIRONMENT" | "PUBLIC_API_HOST" | "PUBLIC_API_PROTOCOL">> {}
}
