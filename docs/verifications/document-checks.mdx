...
| Code | Meaning |
|---|---|
| `document_authenticity_failed` | Passive auth failed — the SOD signature, the DSC chain, a data-group hash, or CRL revocation rejected the document. |
