...
- **Authenticated cancel** — `POST /v1/sessions/:id/cancel` with your API key. Idempotent. Use this when you decide server-side that you no longer want the verification to proceed.
