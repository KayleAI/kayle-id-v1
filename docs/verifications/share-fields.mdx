---
title: "Share fields"
description: "The catalogue of claims you can request for a Kayle check."
icon: "list-check"
---
...
When Kayle confirms an attempt, the `verification.attempt.succeeded` webhook returns the consented claims:
