...
description: "How Kayle ID delivers verification results to your servers."
icon: "bolt"
---
...
Endpoints that don't return `2xx` after three attempts (initial plus two retries) are marked `failed`. You can replay or retry them from the dashboard or via the API; see [Deliveries](/webhooks/deliveries).
