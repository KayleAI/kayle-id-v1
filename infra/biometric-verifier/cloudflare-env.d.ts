/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example --env-interface BiometricVerifierBindings cloudflare-env.d.ts` (hash: 5178d4818552c29a7efbc5d7336d3e23)
// Runtime types generated with workerd@1.20260415.1 2026-03-20 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BiometricVerifierContainer";
	}
	interface ProductionEnv {
		BIOMETRIC_VERIFIER_SECRET: string;
		BIOMETRIC_VERIFIER_CONTAINER: DurableObjectNamespace<import("./src/index").BiometricVerifierContainer>;
	}
	interface Env {
		BIOMETRIC_VERIFIER_SECRET?: string;
		BIOMETRIC_VERIFIER_CONTAINER: DurableObjectNamespace<import("./src/index").BiometricVerifierContainer>;
		BIOMETRIC_VERIFIER_ALLOW_PIXEL_FALLBACK?: "1";
	}
}
interface BiometricVerifierBindings extends Cloudflare.Env {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BIOMETRIC_VERIFIER_SECRET" | "BIOMETRIC_VERIFIER_ALLOW_PIXEL_FALLBACK">> {}
}
