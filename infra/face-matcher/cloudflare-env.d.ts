/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example --env-interface FaceMatcherBindings cloudflare-env.d.ts` (hash: d795c6892eb8d1ee297067ec94c82d60)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FACE_MATCHER_SECRET">> {}
}
