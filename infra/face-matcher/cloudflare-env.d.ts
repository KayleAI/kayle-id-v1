/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example --env-interface FaceMatcherBindings cloudflare-env.d.ts` (hash: 5178d4818552c29a7efbc5d7336d3e23)
...
declare namespace Cloudflare {
	...
	interface Env {
		FACE_MATCHER_SECRET?: string;
		FACE_MATCHER_CONTAINER: DurableObjectNamespace<import("./src/index").FaceMatcherContainer>;
		FACE_MATCHER_ALLOW_PIXEL_FALLBACK?: "1";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FACE_MATCHER_SECRET" | "FACE_MATCHER_ALLOW_PIXEL_FALLBACK">> {}
}
