...
export function VerifyEmailEmail({
  ...
  return (
    <Html>
      <Head>
        <title>Confirm your Kayle ID email</title>
        <Font fallbackFontFamily="Arial" fontFamily="Inter" />
      </Head>
      <Preview>Confirm {email} is your Kayle ID email</Preview>
      <Tailwind>
          ...
          <Container className="mx-auto my-8 max-w-[500px] bg-neutral-100">
            ...
            <Section className="max-w-sm px-8 text-center">
              ...
              <Text className="mb-6 text-center text-neutral-700 text-sm leading-relaxed">
                Click the button below to confirm that {email} is the email
                address for your Kayle ID account. The link will expire in{" "}
            ...
            <Section className="border-neutral-200 border-t px-8 pb-8 text-center">
              ...
              <Text className="mx-auto mb-4 max-w-sm text-center text-neutral-500 text-xs leading-relaxed">
                ...
                requested email verification on a Kayle ID account associated
                with this address. If this wasn't you, no action is required.
              </Text>
...
export default function PreviewVerifyEmailEmail() {
  return (
    <VerifyEmailEmail
